...
- (void)drawDiamond {
    ...
    [p moveToPoint:CGPointMake(c.x, c.y-40)];
    [p addLineToPoint:CGPointMake(c.x+20, c.y)];
    [p addLineToPoint:CGPointMake(c.x, c.y+40)];
    [p addLineToPoint:CGPointMake(c.x-20, c.y)];
...
- (void)drawOval {
    ...
    CGRect rect = CGRectMake(c.x-20, c.y-40, 40.0, 80.0);
...
- (void)drawSquiggle {
    ...
    [squiggle moveToPoint:CGPointMake(c.x-20, c.y-40)];
    [squiggle addLineToPoint:CGPointMake(c.x+20, c.y+40)];

    [squiggle addCurveToPoint:CGPointMake(c.x-20, c.y-40)
                controlPoint1:CGPointMake(c.x+50, c.y-40)
                controlPoint2:CGPointMake(c.x+20, c.y+40)];
    [squiggle stroke];
}
